...
try:
    ...
    create_synthetic_splits = None
    generate_synthetic_metadata = None
...
if create_synthetic_splits and generate_synthetic_metadata:
    __all__ += ["create_synthetic_splits", "generate_synthetic_metadata"]
